...
PARSERS: dict[str, ParserFn] = {
    ...
    # slice 15: more catalog tools wired
    "feroxbuster": feroxbuster.parse,
    "feroxbuster_json": feroxbuster.parse,
    "nikto": nikto.parse,
    "nikto_json": nikto.parse,
    "wapiti": wapiti.parse,
    "wapiti_json": wapiti.parse,
    "retirejs": retirejs.parse,
    "retirejs_json": retirejs.parse,
    "schemathesis": schemathesis.parse,
    "schemathesis_text": schemathesis.parse,
    "schemathesis_json": schemathesis.parse,  # legacy parser id from YAML
    "jwt-tool": jwt_tool.parse,
    "jwt_tool_text": jwt_tool.parse,
    "polaris": polaris.parse,
